...
def seed_demo() -> None:
    ...
    drafts = [
        ...
        {"id": 3, "title": "Улучшить доставку по городу", "topic": "Логистика", "users": "Диспетчеры службы доставки"},
    ...
    published = [
        ...
        {"id": 9, "title": "Оптимизировать маршруты доставки", "topic": "Логистика", "context": "Маршруты доставки пересекаются", "need": "Сократить время в пути", "users": "Диспетчеры службы доставки", "data": "Адреса доставки", "expected_result": "Прототип планировщика маршрутов", "constraints": "Без отслеживания водителей"},
