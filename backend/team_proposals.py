...
DEMO_PROPOSALS = (
    (1, "Сделать очередь обращений понятнее: показать приоритет, тему и время ожидания ответа.", "Проведём интервью с операторами, соберём карту работы с обращением и проверим кликабельный прототип.", "2 недели", "https://example.com/prototypes/pixel-lab"),
    (2, "Найти причины долгого ответа и предложить прозрачные правила приоритизации обращений.", "Согласуем доступ к обезличенной истории, изучим время обработки и подготовим макет отчёта.", "10 рабочих дней", "https://example.com/prototypes/data-pulse"),
    (3, "Сократить передачу обращений между операторами с помощью распределения по темам.", "Изучим процесс поддержки, согласуем правила распределения и проверим прототип на учебных примерах.", "3 недели", "https://example.com/prototypes/green-stack"),
    (4, "Подготовить единый экран оператора с очередью, фильтрами и шаблонами ответов.", "Уточним ограничения интеграции, соберём интерактивный прототип и проверим основные сценарии.", "12 дней", "https://example.com/prototypes/craft-code"),
    (5, "Улучшить первые ответы клиентам: объяснять следующий шаг и ожидаемое время решения.", "Согласуем тон сообщений, подготовим шаблоны и проверим их понятность на учебных обращениях.", "2,5 недели", "https://example.com/prototypes/market-makers"),
)
